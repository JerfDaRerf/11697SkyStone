...
@Autonomous(name="BlueSuperStoned", group ="11697")
//BLUE Left has "public class BlueLeft extends LinearOpMode
public class BlueSuperStoned extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.leftSide.setPosition(0.0);
        robot.rightSide.setPosition(1);
        robot.pinchyBoi.setPosition(1);
        ...
        while (opModeIsActive()) {
            ...
            //Move up to stones
            driveByEncoder(0.4, -11.5, -11.5);

            //Clamp first stone
            robot.leftSide.setPosition(.97);
            sleep(700);

            //Move back and under the bridge
            driveByEncoder(0.4, 2,2);
            rotate(85,0.3);
            driveByEncoder(0.4, -10,-10);
            ...
            robot.leftSide.setPosition(0);
            sleep(300);

            //Move to third stone
            driveByEncoder(0.4,12,12);
            rotate(-85,0.3);
            driveByEncoder(0.25,-3.5,-3.5);

            robot.rightSide.setPosition(0);
            sleep(700);

            //Park under the bridge
            driveByEncoder(0.4, 2.5,2.5);
            rotate(85,0.3);
            driveByEncoder(0.4,-16,-16);
